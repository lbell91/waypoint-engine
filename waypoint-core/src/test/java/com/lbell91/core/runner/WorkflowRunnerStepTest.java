...
public class WorkflowRunnerStepTest {
    ...
    void runStep_executes_once_action_and_transitions_once() {
        ...
        var processCmd = ActionCommand.<Ctx>of(PROCESS);
        ...
        // Your WorkflowRunner now requires (actionToExecute, stepIndex)
        var step1 = runner.runStep(def, State.START, new Ctx("context-1"), beginCmd, 1);
        ...
        var step2 = runner.runStep(def, step1.toState(), new Ctx("context-2"), processCmd, 2);
